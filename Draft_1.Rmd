...
I start with the terms that have no interaction. For labour force there is a statistically significant difference between those in full time job and those unemployed with those unemployed having an associated decrease in expenditure of (8.5%,34.1%) compared to those in full time work with all other variables held constant. The other factor levels of labour force (Part time and inactive) are not significantly different when compared to full time workersa
...
Due to income squared term the associated effect of an increase in income on expenditure depends on the initial value of income
