...
Due to the model being a log-linear model the explanatory variables have a multiplicative effect on expenditure. Exponentiating the estimated coefficients to find their effect on expenditure gives the below table. I note that all values have been rounded to 4 decimal places thus the zero p-values are due to p-values being too small to be displayed and similarly for effect of income squared. My following inference will be based on this table and I use a significance level of 5%.
...
```
The difference between full time work and being unemployed was highly statistically significant. With unemployed households compared to full time employment households having a 95% confidence interval (CI) of [0.659, 0.915] which corresponds to a **8.5%** to **34.1%** decrease in expenditure with all other variables held constant. Furthermore, as the CI of unemployed and part-time employment do not overlap there is a statistically significant increase in expenditure if a household is in part time employment compared to unemployed households with all other variables held constant.

However the difference between full time work and being inactive or in part time work was not significant (the 95% CI included 1) therefore with all other variables constant there is no evidence that being in one of these three employment groups compared to another influences the expenditure of the household.
...
Sex of household head and household size have an interaction between them therefore cannot be reported separately. To easily display the effects of both on expenditure I created the below table which displays the multiplicative effect of sex and household size on expenditure.
...
Overall an increase in income (except for intially extremely high incomes), living in an owned or privately rented property compared to a publicly rented property and being in full or part time employment compared to unemployed increases the expenditure of the household. With household size increasing income if household head is male and being a female household head increases expenditure for certain household sizes (1, 2 and 4) and having no proven effect for others (3 and 5+).

It is important to remember that the relationships found in this analysis does not imply causation as they may be affected by confounding, chance or bias from the sample the model was based on. Including additional factors that could potentially be confounders such as the age of the household head, ethnicity of household and location of household would improve the confidence in the relationships found. Furthermore, a larger sample would enable the effect of sex of household head to be better understood for all household sizes.
