...
#Finding max value of icome in dataset
...
test <- data.frame("Init.inc"=c(x,x),
...
ggplot(aes(Init.inc,Inc.expend,colour=Inc.inc),data=test)+
  geom_line()+
...
ggplot(aes(Init.inc,Inc.expend,colour=Inc.inc),data=test)+
  ...
  ylab("Increase in expenditure (%)")+
  xlab("Initial income (£)")+
  ggtitle("Effect of income on expenditure")
```
