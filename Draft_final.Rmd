...
data.sex.household.CI <- data.frame(t(data.frame("Male"=male.CI, "Female"=female.CI)))%>%
  rename("1 Person"="X1",
         "2 Persons"="X2",
         "3 Persons"="X3",
         "4 Persons"="X4",
...
knitr::kable(data.sex.household.CI,digits=3,caption = "95% CI compared to male headed household of 1 person")%>%
  row_spec(0,bold=T)%>%
